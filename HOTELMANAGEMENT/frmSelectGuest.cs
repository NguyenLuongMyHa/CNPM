...
namespace HOTELMANAGEMENT
{
    public partial class frmSelectGuest : Form
    {
        ...
        private void DgvGuest_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            string Status = dgvGuest.Rows[r].Cells[8].Value.ToString();
            string Remark = dgvGuest.Rows[r].Cells[9].Value.ToString();
            string Username = dgvGuest.Rows[r].Cells[10].Value.ToString();

            User GuestSelected = new User();
            GuestSelected.SetUser(ID, FName, MName, LName, Address, ContactNum, Gender, Email, Status, Remark, Username);
            // bien toan cuc luu guest nao duoc chon
            public_class.guestSelected = GuestSelected;
            public_class.isGuestSelected = true;
            MessageBox.Show("Guest " + public_class.guestSelected.UserFName + " " + public_class.guestSelected.UserMName + " " + public_class.guestSelected.UserLName + " Selected");
            this.Close();
        }                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
    }
}
